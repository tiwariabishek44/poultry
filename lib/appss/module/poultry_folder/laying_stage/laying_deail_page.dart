...
class LayingDetailPage extends StatefulWidget {
  final Map<String, dynamic> batch;

  LayingDetailPage({Key? key, required this.batch}) : super(key: key);

  @override
  State<LayingDetailPage> createState() => _LayingDetailPageState();
}

class _LayingDetailPageState extends State<LayingDetailPage> {
            ...
            children: [
              ...
              Container(
                  ...
                  child: ElevatedButton(
                      onPressed: () {
                        Get.to(() => OveralPerformance(
                              batch: widget.batch,
                            ));
                      },
                      child: Text('Overal Performace',
                          style: GoogleFonts.inter(
                            fontSize: 16.sp,
                            fontWeight: FontWeight.w600,
                            color: Colors.white,
