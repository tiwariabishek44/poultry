...
import 'package:poultry/appss/module/poultry_folder/eggWasteReport/eggWasteReportController.dart';
import 'package:nepali_date_picker/nepali_date_picker.dart';
import 'package:poultry/appss/widget/nepai_year_month_picker.dart';
import 'package:responsive_sizer/responsive_sizer.dart';
import 'package:shimmer/shimmer.dart';

class EggWasteReport extends StatefulWidget {
  EggWasteReport({Key? key}) : super(key: key);

  @override
  State<EggWasteReport> createState() => _EggWasteReportState();
}

class _EggWasteReportState extends State<EggWasteReport> {
  final controller = Get.put(EggWasteReportController());
// Add helper method
  String _truncateText(String text) {
    return text.length > 6 ? '${text.substring(0, 4)}...' : text;
  }
...
// Initial date in the format 'yy-mm'
  ...
  // Function to show the date picker inside an AlertDialog
      ...
      children: [
        ...
        Expanded(
          child: StreamBuilder<QuerySnapshot>(
            stream: controller.getCollectionsStream(_selectedDate),
...
// Sort the documents by date in descending order
              ...
              return ListView.separated(
                ...
                separatorBuilder: (_, __) => Divider(
                  height: 4.h,
                  color:
                      const Color.fromARGB(255, 138, 137, 137).withOpacity(0.2),
                ),
